			...
			initLoading: function(){
				var _this = this,
					...
					manifest = [
						...
						{src:this.loadingPath+'num1.png'},
						{src:this.loadingPath+'num2.png'},
						{src:this.loadingPath+'num3.png'},
						{src:this.loadingPath+'num4.png'},
						{src:this.loadingPath+'num5.png'},
						{src:this.loadingPath+'num6.png'},
						{src:this.loadingPath+'num7.png'},
						{src:this.loadingPath+'num8.png'},
